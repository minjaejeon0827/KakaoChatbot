...
class KakaoResponseFormatter:   # 암시적으로 object 클래스 상속
    ...
    def __init__(self, master_datas: dict[str, Any] | None = None) -> None:
        """
    ...
    def __skillTemplate_format(self, outputs: list[dict] | None = [], quickReplies: list[dict] | None = []) -> dict[str, Any]:
        ...
        Parameters: self - 카카오 스킬 응답 템플릿 json 포맷 클래스 (KakaoResponseFormatter) 인스턴스 (Instance)
                    outputs - 출력 그룹 리스트 (default parameter)
    ...
    def simple_text(self, text: str | None = None) -> dict[str, Any]:
        ...
        Parameters: self - 카카오 스킬 응답 템플릿 json 포맷 클래스 (KakaoResponseFormatter) 인스턴스 (Instance)
                    text - 챗봇 답변 내용 (default parameter)
    ...
    def error_text(self, error_msg: str | None = None) -> dict[str, Any]:
        ...
        Parameters: self - 카카오 스킬 응답 템플릿 json 포맷 클래스 (KakaoResponseFormatter) 인스턴스 (Instance)
                    error_msg - 오류 메세지 (default parameter)
