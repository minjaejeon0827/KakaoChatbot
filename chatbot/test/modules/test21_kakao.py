...
class KakaoResponseFormatter:   # 암시적으로 object 클래스 상속
    ...
    def get_response(self, userRequest_msg: str) -> dict[str, Any]:
        ...
        Returns: dict[str, Any] key "payload" - 카카오 json 포맷 기반 챗봇 답변 내용 (페이로드),
    ...
    def __empty_response(self, master_data: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns: { "payload": empty_format, "meta_data": master_data } - 비어있는 메세지 json 포맷 (페이로드)
        """
        ...
        return { "payload": self.__skillTemplate_format(outputs), "meta_data": master_data }
    ...
    def __common_basicCard(self, master_data: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns: self.__basicCard_format(master_data, buttons) - [공통] 기본형 카드 json 포맷 (페이로드)
                 master_data - 특정 마스터 데이터
        """
    ...
    def __common_quickReplies(self, master_data: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns: self.__quickReplies_format(master_data, quickReplies) - [공통] Autodesk or 상상진화 BOX 제품 설치 지원 바로가기 그룹 json 포맷 (페이로드) 
                 master_data - 특정 마스터 데이터
        """
    ...
    def __common_ver_quickReplies(self, userRequest_msg: str, master_data: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns: self.__quickReplies_format(master_data, quickReplies) - [공통] Autodesk or 상상진화 BOX 제품 버전 바로가기 그룹 json 포맷 (페이로드)
                 master_data - 특정 마스터 데이터
        """
    ...
    def __chatbot_carousel(self, master_data: dict[str, Any]) -> dict[str, Any]:
        ...
        Returns: self.__carousel_format(master_data, chatbot_items) - 챗봇 문의 아이템형 케로셀 json 포맷 (페이로드)
                 master_data - 특정 마스터 데이터
        """
    ...
    def __end_basicCard(self, userRequest_msg: str, master_data: dict[str, Any], endInfos: list[dict]) -> dict[str, Any]:
        ...
        Returns: self.__skillTemplate_format(outputs) - 마지막화면 기본형 카드 json 포맷 (페이로드)
                 master_data - 특정 마스터 데이터
        """
