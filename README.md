...
2024.12 ~ 2025.12 · 기획/개발/배포/운영(일부 고객 대상) 1인 담당
...
| 2025.04 | **1인 개발 체제 전환** | 초기 참여 PM·웹개발자 퇴사. 기획·개발·배포·운영(일부 고객 대상) 전 범위 단독 수행 |
...
| 운영(일부 고객 대상) | CloudWatch 기반 장애 대응, 제품/버전 변경 반영, 콘텐츠 갱신 |
| 문서화 | Docstring 형식 기반 주요 사항 작성 |

**이 과정에서 얻은 것**

기존 오프라인 기술지원 서비스를 온라인으로 확장하는 일은 도전적인 과제였다.
함께 시작한 팀원들이 떠난 뒤 1인 개발로 마무리하면서, 기획부터 운영(일부 고객 대상)까지 프로젝트 전체 주기를 책임지는 경험을 하였다.
