...
2024.12 ~ 2025.12 · 기획/개발/배포/운영(일부 고객사 대상) 1인 담당
...
기존 오프라인 기술지원을 **온라인에서도 기술지원 받을 수 있도록** 카카오톡 채널 기반 자동 응대 서비스를 구축했다.
...
| 지원 버전 | Autodesk 제품 2023-2026 / BOX 제품 2022-2026 |
...
사용자가 자연어로 질문할 필요 없이, **버튼 선택만으로** 원하는 제품 설치 가이드를 안내 받을 수 있다.
...
| 2025.04 | **1인 개발 체제 전환** | 초기 참여 PM·웹개발자 퇴사. 기획·개발·배포·운영(일부 고객사 대상) 전 범위 단독 수행 |
...
| 2025.09 | `lambda_function.py` **코드 리팩토링** | 핸들러 비대화 해소 — 파싱·스레드·대기·포맷 책임 분리 |
...
| 운영(일부 고객사 대상) | CloudWatch 기반 장애 대응, 제품/버전 변경 반영, 콘텐츠 갱신 |
| 문서화 | Docstring 형식 기반 주요 사항 작성 |

**이 과정에서 얻은 것**

기존 오프라인 기술지원 서비스를 온라인으로 확장하는 일은 도전적인 과제였다.
함께 시작한 팀원들이 떠난 뒤 1인 개발로 마무리하면서, 기획부터 운영(일부 고객사 대상)까지 프로젝트 전체 주기를 책임지는 경험을 하였다.
...
마스터 데이터 기반 계층형 버튼 응대. Autodesk 제품 설치 문의를 자동화 처리한다.
